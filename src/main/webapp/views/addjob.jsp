            ...
            <%@ page isELIgnored="false" %>
                ...
                <body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
                        <div class="container">
                            <a class="navbar-brand fs-1 fw-medium" href="#">Job App Portal</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form:form action="handleForm" method="post" modelAttribute="jobPost">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <textarea class="form-control" id="postDesc" name="postDesc" rows="2"
                                                    required></textarea>
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select multiple class="form-select" id="postTechStack"
                                                    ...
                                                    <option value="IoT (Internet of Things)">IoT (Internet of Things)
                                                    </option>
                                                    ...
                                                    <option value="AWS (Amazon Web Services)">AWS (Amazon Web Services)
                                                    </option>
                                                    ...
                                                    <option value="Certified Ethical Hacker (CEH)">Certified Ethical
                                                        Hacker (CEH)</option>
